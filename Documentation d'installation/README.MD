...
**SPARK_HISTORY_OPTS**: Pour voir des histoire de logs
...
**spark.eventLog.enabled**: Pour stoquer des logs

**spark.eventLog.dir** et **spark.history.fs.logDirectory** : des chemin pour des logs
